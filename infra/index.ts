...
const dockerImage = new docker.Image("review-predictionkyapbwefxcmy-image", {
    imageName: `docker.io/${config.require("dockerUsername")}/review-predictionkyapbwefxcmy-image:latest`, // Use your Docker Hub username and desired image name
    build: {
...
const appName = "review-predictionkyapbwefxcmy";
...
const hpa = new k8s.autoscaling.v2.HorizontalPodAutoscaler(
  "review-predictionkyapbwefxcmy-hpa",
  {
    spec: {
      scaleTargetRef: {
        apiVersion: "apps/v1",
...
new TraefikRoute(
  "review-predictionkyapbwefxcmy",
  {
    prefix: "/models/review-predictionkyapbwefxcmy",
    service,
    namespace: "default",
  },
